...
public:
	...
	void show_stats()
	{
		...
		////////////////////////////////////
		std::cout << "Average wait time for all planes in arrival queue: " << double(double(landing_queue->get_total_wait())/double(landing_queue->get_num_served())) << std::endl;
		////////////////////////////////////
		...
		/////////////////////////////////////
		std::cout << "Average wait time for all planes in departure queue: " << double(double(departure_queue->get_total_wait())/double(departure_queue->get_num_served())) << std::endl;
		/////////////////////////////////////
		std::cout << std::endl;
